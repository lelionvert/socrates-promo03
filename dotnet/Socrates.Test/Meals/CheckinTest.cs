...
namespace Socrates.Test.Meals
{
    internal class CheckinTest
    {
        ...
        {
            // SETUP
            var participantCheckinDate = new DateTime(2018, 10, 10, 21, 30, 40);
            var participantCheckin = new Checkin(Email.Of("regis.dubois@socrates.com"), participantCheckinDate);

            var periodStartingDate = new DateTime(2018, 10, 09);
            var periodEndingDate = new DateTime(2018, 12, 02);
        ...
        {
            // SETUP
            var participantCheckinDate = new DateTime(2018, 05, 10, 21, 30, 40);
            var participantCheckin = new Checkin(Email.Of("regis.dubois@socrates.com"), participantCheckinDate);
